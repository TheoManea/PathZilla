...
public class SearchReaction {
    ...
    public void writeOutputToFile(){
        try {
            FileWriter myWriter = new FileWriter(Paths.get("").toAbsolutePath()+"/src/main/java/com/example/gui_version/outputFiles/output-d"+depth+"-"+startingPoint+"-"+endingPoint+".txt",true);
            myWriter.write("// Reactions \n\n");
